    ...
    <div class="container">
        <div class="card">
            <h5 class="card-header">
                Guest List <a href="/list/add-guest" class="btn btn-secondary">Add</a>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-6-col-sm-3">
                                        <a href="/list/edit-guest/{{$guest->id}}" class="btn btn-success">Edit</a>
                                    </div>
                                    <div class="col-6-col-sm-3">
                                        <a href="/list/delete-guest/{{$guest->id}}" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
