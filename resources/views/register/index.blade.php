            ...
            <div class="right mx-lg-0 mx-auto">
                ...
                <form style="margin-top: 1.5rem" action="/register" method="post">
                    ...
                    <div style="margin-bottom: 1.75rem">
                        <label type="email" id="email" name="email" for="email" class="d-block input-label">Full Name</label>
                        <div class="d-flex w-100 div-input">
                            ...
                            <input class="input-field border-0 @error('name') is-invalid @enderror" type="name" name="name" id="name" placeholder="Your Full Name" autocomplete="on" required required value="{{ old('name') }}" />
                            @error('name')
                    ...
                    <!-- Email -->
                    <div style="margin-bottom: 1.75rem">
                        <label type="text" id="" name="" for="" class="d-block input-label">Email Address</label>
                        <div class="d-flex w-100 div-input @error('email') is-invalid @enderror">
                            <svg class="icon" style="margin-right: 1rem" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M5 5C3.34315 5 2 6.34315 2 8V16C2 17.6569 3.34315 19 5 19H19C20.6569 19 22 17.6569 22 16V8C22 6.34315 20.6569 5 19 5H5ZM5.49607 7.13174C5.01655 6.85773 4.40569 7.02433 4.13168 7.50385C3.85767 7.98337 4.02427 8.59422 4.50379 8.86823L11.5038 12.8682C11.8112 13.0439 12.1886 13.0439 12.4961 12.8682L19.4961 8.86823C19.9756 8.59422 20.1422 7.98337 19.8682 7.50385C19.5942 7.02433 18.9833 6.85773 18.5038 7.13174L11.9999 10.8482L5.49607 7.13174Z" fill="#CACBCE" />
                            </svg>
                            <input class="input-field border-0 @error('email') is-invalid @enderror" type="email" name="email" id="email" placeholder="Your Email Address" autocomplete="on" required required value="{{ old('email') }}" />
                            @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div style="margin-top: 1rem">
                        ...
                        <div class="d-flex w-100 div-input">
                            ...
                            <input class="input-field border-0 @error('password') is-invalid @enderror" type="password" name="password" id="password-content-3-5" placeholder="Your Password" required />
                            @error('password')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <p class="text-center bottom-caption">
                    ...
                    <span><a class="green-bottom-caption" href="/login">LogIn Here</a></span>
                </p>
            </div>
        </div>
    </div>
