            ...
            <div class="right mx-lg-0 mx-auto">
                ...
                <form style="margin-top: 1.5rem" action="/login" method="post">
                    ...
                    <div style="margin-bottom: 1.75rem">
                        <label type="email" id="email" name="email" for="email" class="d-block input-label">Email Address</label>
                        <div class="d-flex w-100 div-input">
                            ...
                            <input class="input-field border-0  @error('email') is-invalid @enderror" type="email" name="email" id="email" placeholder="Your Email Address" autocomplete="on" autofocus required />
                        </div>
                    </div>
                ...
                <p class="text-center bottom-caption">
                    ...
                    <span><a class="green-bottom-caption" href="/register">Register Here</a></span>
                </p>
            </div>
        </div>
    </div>
