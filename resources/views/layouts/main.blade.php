...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          ...
          <div class="d-flex">
            <ul class="navbar-nav">
              ...
              <li>
                @can('admin')
                <button type="submit" class="dropdown-item btn btn-get-started-blue text-white" onclick="window.location.href='/dashboard'">
  ...
  <div class="text-center py-4 px-4 px-xl-5 bg-light {{ ($title === "List" ) ? 'fixed-bottom' : '' }}">
    <!-- Copyright -->
    <div class="text-dark">
